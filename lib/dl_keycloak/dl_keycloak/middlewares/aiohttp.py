...
import dl_keycloak.clients as clients
import dl_keycloak.middlewares.models as middlewares_models
import dl_keycloak.services as services
...
class AioHTTPMiddleware:
    _client: clients.KeycloakAsyncClient
    _token_storage: services.KeycloakAsyncTokenStorage
    ...
    def get_middleware(self) -> dl_api_commons_aio_typing.AIOHTTPMiddleware:
        ...
        async def inner(
            ...
            service_access_token = app_request.get_single_header(middlewares_models.KeycloakHeaders.SERVICE_ACCESS_TOKEN)
            ...
            app_request.replace_temp_rci(
                attr.evolve(
                    ...
                    auth_data=middlewares_models.KeycloakAuthData(
